...
G1 = create_st_graph(graph_1, targets_1,'t')
...
G2 = create_st_graph(graph_2, targets_2,'t')
...
G3 = create_st_graph(graph_3, targets_3,'t')
...
G4 = create_st_graph(graph_4, targets_4,'t')
